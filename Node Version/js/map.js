$(function () {
  ...
  // AJAX call to get refinery data. On success, if populates the map and binds
  // popups
  $.get("/refineries", function (res) {
    const markers = populateMap(res.refineries);
    bindPopups(markers, res.refineries);
  });
});


//  You can condense the functions above into one neat fucntion
//  var markers = [];
//  for (var i = 0; i < refineries.length; i++) {
